    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="text-align:right;cursor:pointer" onclick="sortTable(1)">Stock ↕</th>
                <th style="text-align:right;cursor:pointer" onclick="sortTable(2)">Scorta Min ↕</th>
                <th style="text-align:right;cursor:pointer" onclick="sortTable(3)">Costo €/kg ↕</th>
                <th>Unità</th>
        ...
        @empty
        <tr>
            <td colspan="7" style="text-align:center;padding:40px;color:var(--muted)">Nessun prodotto in magazzino</td>
        </tr>
        @endforelse
        </tbody>
    </table>
